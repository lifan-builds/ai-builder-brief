...
Review the generated `build/shadow/` artifacts for citation qualification, story duplication, transcript quality, and duration. Freeze the story count when the seven-run median is 8–12 minutes; adjust by one story at a time if it is outside the range.
